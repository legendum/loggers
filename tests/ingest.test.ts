...
const TEST_CONTROL_DB = "data/test-ingest-control.db";
const TEST_LOGGER_DIR = "data/test-ingest-per-ulid";
const PORT = 3043;
...
beforeAll(async () => {
  ...
  svc = await bootTestService(() => import("../src/api/server"), {
    ...
    env: { LOGGERS_DB_DIR: TEST_LOGGER_DIR, LOGGERS_MAX_BATCH: "10" },
  });
  base = svc.base;
